...
describe('social sharing metadata', () => {
  it('ships complete Open Graph metadata in the static HTML', () => {
    ...
    expect(metaContent('og:image')).toBe('https://caniworknow.com/og-v3.png')
    expect(metaContent('og:image:secure_url')).toBe('https://caniworknow.com/og-v3.png')
